...
class ConversationsListActivity :
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_filter_conversations -> {
                val newFragment: DialogFragment = FilterConversationFragment.newInstance(HashMap(filterState))
                newFragment.show(supportFragmentManager, "fragment_filter_dialog")
                return true
            }
            R.id.action_server_selection -> {
                val newFragment: DialogFragment = ChooseAccountDialogFragment.newInstance()
                newFragment.show(supportFragmentManager, ChooseAccountDialogFragment.TAG)
                return true
            }
